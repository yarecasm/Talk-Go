...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-12-2025 a las 00:28:13
...
INSERT INTO `recompensas` (`ID_RECOMPENSA`, `NOMBRE`, `DESCRIPCION`, `TIPO`, `PUNTOS`, `VALOR_DESCUENTO`, `ID_PRODUCTO_ASOCIADO`, `ESTADO`) VALUES
(1, 'Bacon Bagel', 'Get two bacon bagels with the purchase of one', '2x1', 50, 1, 2, 1),
(2, 'Iced Latte', 'With the purchase of any other product', 'gratis', 40, 1, 8, 1),
(3, 'Bigñets', 'With the purchase of any other product', 'gratis', 60, 1, 16, 1),
(4, 'Discount', 'Get half price on your purchase', 'porcentaje', 70, 50, NULL, 1),
(5, 'Salmon Bagel', 'Get three salmon bagels with the purchase of two', '3x2', 40, 1, 3, 1);
